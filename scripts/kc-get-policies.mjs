...
async function getPolicies() {
  ...
  const endpoint = `${KEYCLOAK_URL.replace(/\/$/, '')}/admin/realms/${encodeURIComponent(REALM)}/client-policies/policies`;
...
getPolicies().catch(err => { console.error(err); process.exit(1); });
